...
public class SellerMenuController {
    ...
    @FXML
    public void SellerCustomerShowBtn(ActionEvent event) throws IOException {
    ...
    @FXML
    public void sellerBillShow(ActionEvent event) throws IOException {
    ...
    @FXML
    public void sellerExit(ActionEvent event) {
